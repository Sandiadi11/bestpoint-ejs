  ...
  const places = [
    {
      ...
      image: "https://source.unsplash.com/collection/1920814/1280x720",
    },
    {
      title: "Pantai Kuta",
      price: 0,
  ...
  try {
    const newPlace = await Promise.all(
      places.map(async (place) => {
        ...
        return {
          ...place,
          author: "67a97167601595f71787c80d",
          images: {
            url: "public\\images\\image-1739259130909-701549616.jpg",
            filename: "image-1739259130909-701549616.jpg",
          },
          geometry: { ...geoData },
        };
      })
